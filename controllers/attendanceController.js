...
//   }
// };
//uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuunwe
// const Attendance = require("../models/Attendance");
// const User = require("../models/User");
// const Branch = require("../models/Branch");
// const { isWithinRadius } = require("../helpers/location");
...
// دالة مساعدة للتحقق من الجهاز وتسجيله
...
//   if (!registeredDevice) {
//     // جهاز جديد - تسجيله
//     const approved = user.registeredDevices.length === 0; // أول جهاز يُوافق عليه تلقائياً
    
//     const newDevice = {
//       deviceId,
//       deviceFingerprint: browserFingerprint, // استخدم browserFingerprint هنا
//       userAgent,
//       approved,
...
//     // إرسال تنبيه للأدمن إذا لم يكن الجهاز الأول
//     if (!approved) {
//       await sendAlert(
//         process.env.EMAIL_USER , 
//         'طلب موافقة على جهاز جديد', 
//         `المستخدم ${user.name} يطلب موافقة على جهاز جديد.\nمعلومات الجهاز: ${userAgent}`
//       );
...
//     registeredDevice.deviceFingerprint = browserFingerprint; // تحديث fingerprint المتصفح
//     await user.save();
